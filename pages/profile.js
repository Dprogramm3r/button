import {
 ...
 export function Profile() {
  ...
  return(  
    <> 
<nav class="bg-black border-gray-200 px-2 sm:px-4 py-2.5 rounded white:bg-blue-900">
  <div class="container flex flex-wrap items-center justify-between mx-auto">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-black dark:bg-blue-800 md:dark:bg-gray-900 dark:border-gray-700">
...
<body>
{error && <div class="block py-2 pl-3 pr-4 text-white-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 
